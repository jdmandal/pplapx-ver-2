...
public class webV extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        webView.setWebViewClient(new webV.myWebClient());
    ...
    private void initGoogleAPIClient() {
        ...
        mGoogleApiClient = new GoogleApiClient.Builder(webV.this)
    ...
    private void checkPermissions() {
        if (Build.VERSION.SDK_INT >= 23) {
            if (ContextCompat.checkSelfPermission(webV.this,
    ...
    private void requestLocationPermission() {
        if (ActivityCompat.shouldShowRequestPermissionRationale(webV.this, android.Manifest.permission.ACCESS_COARSE_LOCATION)) {
            ActivityCompat.requestPermissions(webV.this,
                ...
                switch (status.getStatusCode()) {
                    ...
                    case LocationSettingsStatusCodes.RESOLUTION_REQUIRED:
                        ...
                        try {
                            ...
                            status.startResolutionForResult(webV.this, REQUEST_CHECK_SETTINGS);
    ...
    {
        super.onResume();
        webView.loadUrl("http://my.peopleapex.com/login");
    ...
    protected void onDestroy()
    {
        super.onDestroy();
        webView.destroy();
      webView.loadUrl("https://my.peopleapex.com");
        Toast.makeText(webV.this,"Press back to exit",Toast.LENGTH_LONG).show();
        ...
        switch (requestCode) {
            case ACCESS_COARSE_LOCATION_INTENT_ID: {
                ...
                if (grantResults.length > 0
                    ...
                    Toast.makeText(webV.this, "Location Permission denied.", Toast.LENGTH_SHORT).show();
    ...
    public class myWebClient extends WebViewClient{
        ...
        public void onPageStarted(WebView view, String url, Bitmap favicon) {
            ...
            setTitle("Loading...");
            if(webView.getUrl().toString().matches("https://my.peopleapex.com/logout")){
                webView.destroyDrawingCache();
                webView.destroy();
                webView=null;
                Intent intent=new Intent(webV.this,MainActivity.class);
                startActivity(intent);

                Toast.makeText(webV.this,"press back twice for ou code screen",Toast.LENGTH_SHORT).show();
